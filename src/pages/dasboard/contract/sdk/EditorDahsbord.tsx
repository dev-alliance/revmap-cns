      ...
      icon: (
        <Tooltip title="Overview">
          ...
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M15 20H15.0125" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
    ...
    approval: {
      icon: (
        <Tooltip title="Approvals">
          ...
          <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20 26.25V23.75C20 22.4239 19.4732 21.1521 18.5355 20.2145C17.5979 19.2768 16.3261 18.75 15 18.75H6.25C4.92392 18.75 3.65215 19.2768 2.71447 20.2145C1.77678 21.1521 1.25 22.4239 1.25 23.75V26.25" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M10.625 13.75C13.3864 13.75 15.625 11.5114 15.625 8.75C15.625 5.98858 13.3864 3.75 10.625 3.75C7.86358 3.75 5.625 5.98858 5.625 8.75C5.625 11.5114 7.86358 13.75 10.625 13.75Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M21.25 13.75L23.75 16.25L28.75 11.25" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
      ...
      icon: (
        <Tooltip title="TimeLine">
          ...
          <svg width="28" height="24" viewBox="0 0 28 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M4.86957 12C4.86957 13.332 3.78609 14.4 2.43478 14.4C1.09565 14.4 0 13.332 0 12C0 10.68 1.09565 9.6 2.43478 9.6C3.78609 9.6 4.86957 10.68 4.86957 12ZM3.65217 0V7.2H1.21739V0H3.65217ZM1.21739 24V16.8H3.65217V24H1.21739ZM28 4.8V19.2C28 20.532 26.9165 21.6 25.5652 21.6H10.9565C9.61739 21.6 8.52174 20.532 8.52174 19.2V14.4L6.08696 12L8.52174 9.6V4.8C8.52174 3.468 9.61739 2.4 10.9565 2.4H25.5652C26.9165 2.4 28 3.468 28 4.8ZM25.5652 4.8H10.9565V10.596L9.53217 12L10.9565 13.404V19.2H25.5652V4.8ZM13.3913 8.4H23.1304V10.8H13.3913V8.4ZM13.3913 13.2H20.6957V15.6H13.3913V13.2Z" fill="currentColor" />
          </svg>
      ...
      icon: (
        <Tooltip title="Lifecycle">
          ...
          <svg width="30" height="25" viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.8571 6.94444H15.7143V13.8889L21.8286 17.4167L22.8571 15.7361L17.8571 12.8472V6.94444ZM17.1429 0C13.7329 0 10.4627 1.31696 8.05148 3.66116C5.6403 6.00537 4.28571 9.18479 4.28571 12.5H0L5.65714 18.0972L11.4286 12.5H7.14286C7.14286 9.92151 8.19643 7.44862 10.0718 5.62535C11.9472 3.80208 14.4907 2.77778 17.1429 2.77778C19.795 2.77778 22.3386 3.80208 24.2139 5.62535C26.0893 7.44862 27.1429 9.92151 27.1429 12.5C27.1429 15.0785 26.0893 17.5514 24.2139 19.3746C22.3386 21.1979 19.795 22.2222 17.1429 22.2222C14.3857 22.2222 11.8857 21.125 10.0857 19.3611L8.05714 21.3333C10.3857 23.6111 13.5714 25 17.1429 25C20.5528 25 23.823 23.683 26.2342 21.3388C28.6454 18.9946 30 15.8152 30 12.5C30 9.18479 28.6454 6.00537 26.2342 3.66116C23.823 1.31696 20.5528 0 17.1429 0Z" fill="currentColor" />
          </svg>
      ...
      icon: (
        <Tooltip title="discussion">
          ...
          <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.75 25C8.41848 25 8.10054 24.8683 7.86612 24.6339C7.6317 24.3995 7.5 24.0815 7.5 23.75V20H2.5C1.83696 20 1.20107 19.7366 0.732233 19.2678C0.263392 18.7989 0 18.163 0 17.5V2.5C0 1.1125 1.125 0 2.5 0H22.5C23.163 0 23.7989 0.263392 24.2678 0.732233C24.7366 1.20107 25 1.83696 25 2.5V17.5C25 18.163 24.7366 18.7989 24.2678 19.2678C23.7989 19.7366 23.163 20 22.5 20H14.875L10.25 24.6375C10 24.875 9.6875 25 9.375 25H8.75ZM10 17.5V21.35L13.85 17.5H22.5V2.5H2.5V17.5H10ZM5 6.25H20V8.75H5V6.25ZM5 11.25H16.25V13.75H5V11.25Z" fill="currentColor" />
          </svg>
      ...
      icon: (
        <Tooltip title="share">
          ...
          <svg width="23" height="19" viewBox="0 0 23 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M23 8.86667L14.0556 0V5.06667C5.11111 6.33333 1.27778 12.6667 0 19C3.19444 14.5667 7.66667 12.54 14.0556 12.54V17.7333L23 8.86667Z" fill="currentColor" />
          </svg>

...
export default function QuillToolbar(props: any) {
  ...
  const handleSuperscript = () => {
    ...
    editor.format("script", isSuperscript ? false : "super", "user");
    editor.focus();
  };
  ...
  const handleSubscript = () => {
    ...
    editor.format("script", isSubscript ? false : "sub", "user");
    editor.focus();
  };
        ...
        <span className="ql-formats b-r">
            ...
            >
              ...
              >
                {Font.whitelist.map((font: any) => (
                  <MenuItem
                    className={selectedFontValue === font ? `selected-font ql-font-${font} select-fonts ` : `font ql-font-${font} select-fonts font`}
                    key={font}
                    value={font}
                  >
            ...
            <span className="ql-formats">
              ...
              >
                {SizeStyle.whitelist.map((size: any) => (
                  <MenuItem
                    className={selectedFontSizeValue === size ? `selected-font select-fonts ` : `font select-fonts`}
                    key={size} value={size}>
                    {size}
                  </MenuItem>
                ))}
          ...
          <Tooltip title="Headers" placement="bottom" open={tooltipOpenHeader}>
            <span className="">
              ...
              >
                <MenuItem
                  className={selectedHeadersValue === 0 ? `selected-font select-fonts ` : `font select-fonts`}
                  value={0} style={{ fontSize: "14px" }}>
                  Paragraph
                </MenuItem>
                <MenuItem
                  className={selectedHeadersValue === 1 ? `selected-font select-fonts ` : `font select-fonts`}
                  value={1}
                ...
                <MenuItem
                  className={selectedHeadersValue === 2 ? `selected-font select-fonts ` : `font select-fonts`}
                  value={2}
                ...
                <MenuItem
                  className={selectedHeadersValue === 3 ? `selected-font select-fonts ` : `font select-fonts`}
                  value={3}
                ...
                <MenuItem
                  className={selectedHeadersValue === 4 ? `selected-font select-fonts ` : `font select-fonts`}
                  value={4}
              ...
              >
                <span style={{
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <rect width="10" height="10" rx="2" fill={bgColorSvg === "#D9D9D940" || bgColor === "#fefefe" ? "#E6E6E6" :bgColorSvg} />
                  </svg>
                </span>
              </span>
              <Menu
            ...
            >
              ...
              >
                <span style={{ marginRight: "8px" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                    <rect width="10" height="10" rx="2" fill={fontColorSvg} />
                  </svg>
                </span>
              </span>
              <Menu
              ...
              >
                <div className="d-flex">
                  <MenuItem
                    ...
                    style={{ height: 42, width: 42, padding: 0, border: isListActive == "" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                    onClick={() => {
                  ...
                  <MenuItem
                    ...
                    style={{ height: 42, width: 42, padding: 2, border: isListActive == "default" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                    onClick={() => {
                      handleListClick("default");
                    }}
                  >
                  ...
                  <MenuItem
                    value="lower-alpha"
                    className="mx-1 list-items"
                    style={{ height: 42, width: 42, padding: 2, border: isListActive == "lower-alpha" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                    sx={{
                      ":hover": {
                        border: "1px solid rgb(119, 113, 232) !important"
                      }
                ...
                <div className="d-flex py-2">
                  <MenuItem
                    value="upper-alpha"
                    className="mx-1 list-items"
                    style={{ height: 42, width: 42, padding: 2, border: isListActive == "upper-alpha" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                    sx={{
                      ":hover": {
                        border: "1px solid rgb(119, 113, 232) !important"
                      }
                  ...
                  <MenuItem
                    value="lower-roman"
                    className="mx-1 list-items"
                    style={{ height: 42, width: 42, padding: 2, border: isListActive == "lower-roman" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                    sx={{
                      ":hover": {
                        border: "1px solid rgb(119, 113, 232) !important"
                      }
                  ...
                  <MenuItem
                    value="upper-roman"
                    className="mx-1 list-items"
                    style={{ height: 42, width: 42, padding: 2, border: isListActive == "upper-roman" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                    sx={{
                      ":hover": {
                        border: "1px solid rgb(119, 113, 232) !important"
                      }
          ...
          <Tooltip title="Bullets" placement="bottom" open={tooltipOpenBullets}>
            ...
            >
              <span
                className="d-flex justify-content-center align-items-center"
                style={{ width: 30, cursor: "pointer" }}
                onMouseDown={() => handleListClick("bullet")}
              >
                <BulletSvg />
              </span>
              ...
              >
                <div className="d-flex">
                  <MenuItem
                    ...
                    style={{ height: 24, width: 42, border: isListActive == "" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                    sx={{
                      ":hover": {
                        border: "1px solid #7771E8 !important"
                      }
                  ...
                  >
                    ...
                    >
                      <div>
                        <span className="e-de-bullets hover-color-none" style={{ position: "relative", right: 1 }}>None</span>
                      </div>
                    </div>
                  </MenuItem>
                  <MenuItem
                    ...
                    style={{ height: 24, width: 42, border: isListActive == "bullet-dot-large" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                  ...
                  <MenuItem
                    ...
                    style={{ height: 24, width: 42, border: isListActive == "bullet-circle" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                  ...
                  <MenuItem
                    ...
                    style={{ height: 24, width: 42, border: isListActive == "bullet-square" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                ...
                <div className="d-flex py-2">
                  <MenuItem
                    ...
                    style={{ height: 24, width: 42, border: isListActive == "bullet-flower" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                  ...
                  <MenuItem
                    ...
                    style={{ height: 24, width: 42, border: isListActive == "bullet-arrow" ? "1px solid #7771E8" : '1px solid #cccccc' }}
                  ...
                  <MenuItem
                    ...
                    style={{ height: 24, width: 42, border: isListActive == "bullet-tick" ? "1px solid #7771E8" : '1px solid #cccccc' }}
            ...
            >
              ...
              >
                <div className="d-flex">
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          className={selectedAlign === "left" ? "orientation-svg-selected" : "orientation-svg"}
                        />
                      </svg>
                    </MenuItem>
                  </Tooltip>
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          className={selectedAlign === "center" ? "orientation-svg-selected" : "orientation-svg"}
                        />
                      </svg>
                    </MenuItem>
                  </Tooltip>
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          className={selectedAlign === "right" ? "orientation-svg-selected" : "orientation-svg"}
                        />
                      </svg>
                    </MenuItem>
                  </Tooltip>
                  ...
                  >
                    <MenuItem onClick={() => handleAlignment("justify")} className="orientation">
                      <svg
                        width="16"
                        height="13"
                        viewBox="0 0 10 10"
                      ...
                      >
                        <path
                          ...
                          className={selectedAlign === "justify" ? "orientation-svg-selected" : "orientation-svg"}
                        />
                      </svg>
                    </MenuItem>
                  </Tooltip>
              ...
              >
                ...
                >
                  <div className="d-flex align-items-center justify-content-center" >
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path
                          className={documentPageMargins.title === "Standard" ? "margins-svg-selected" : "margins-svg"}
                          d="M4.06628 1V17M14.395 1V17M1.11523 3.90909H17.346M1.11523 14.0909H17.346M1.79152 17H16.6697C17.0432 17 17.346 16.6744 17.346 16.2727V1.72727C17.346 1.32561 17.0432 1 16.6697 1H1.79152C1.41802 1 1.11523 1.32561 1.11523 1.72727V16.2727C1.11523 16.6744 1.41802 17 1.79152 17Z" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      className=" ml-2"
                    ...
                    >
                      <div
                        ...
                        className={documentPageMargins.title == "Standard" ? "margins-color-selected" : "margins-color"}
                      >
                        Standard
                      </div>
                      <div
                ...
                >
                  <div className="d-flex align-items-center justify-content-center">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path className={documentPageMargins.title === "Narrow" ? "margins-svg-selected" : "margins-svg"} d="M2.80594 1V17M15.6553 1V17M1.11523 2.81818H17.346M1.11523 15.1818H17.346M1.79152 17H16.6697C17.0432 17 17.346 16.6744 17.346 16.2727V1.72727C17.346 1.32561 17.0432 1 16.6697 1H1.79152C1.41802 1 1.11523 1.32561 1.11523 1.72727V16.2727C1.11523 16.6744 1.41802 17 1.79152 17Z" stroke="#7F7F7F" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      className=" ml-2"
                    ...
                    >
                      <div
                        ...
                        className={documentPageMargins.title == "Narrow" ? "margins-color-selected" : "margins-color"}
                ...
                >
                  <div className="d-flex align-items-center justify-content-center">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path className={documentPageMargins.title === "Moderate" ? "margins-svg-selected" : "margins-svg"} d="M3.14408 1V17M15.3172 1V17M1.11523 3.90909H17.346M1.11523 14.0909H17.346M1.79152 17H16.6697C17.0432 17 17.346 16.6744 17.346 16.2727V1.72727C17.346 1.32561 17.0432 1 16.6697 1H1.79152C1.41802 1 1.11523 1.32561 1.11523 1.72727V16.2727C1.11523 16.6744 1.41802 17 1.79152 17Z" stroke="#7F7F7F" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      className=" ml-2"
                    ...
                    >
                      <div
                        ...
                        className={documentPageMargins.title == "Moderate" ? "margins-color-selected" : "margins-color"}
                ...
                >
                  <div className="d-flex align-items-center justify-content-center">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                        <path className={documentPageMargins.title === "Wide" ? "margins-svg-selected" : "margins-svg"} d="M5.51107 1V17M12.9502 1V17M1.11523 3.90909H17.346M1.11523 14.0909H17.346M1.79152 17H16.6697C17.0432 17 17.346 16.6744 17.346 16.2727V1.72727C17.346 1.32561 17.0432 1 16.6697 1H1.79152C1.41802 1 1.11523 1.32561 1.11523 1.72727V16.2727C1.11523 16.6744 1.41802 17 1.79152 17Z" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      className=" ml-2"
                    ...
                    >
                      <div
                        ...
                        className={documentPageMargins.title == "Wide" ? "margins-color-selected" : "margins-color"}
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" viewBox="0 0 16 20" fill="none">
                        <path className={documentPageSize.title !== "Landscape" ? "orientation-svg-selected" : "orientation-svg"} d="M1.77778 0C0.791111 0 0 1.04687 0 2.35252V18.8202C0 20.1141 0.791111 19.9965 1.77778 19.9965H14.2222C15.2089 19.9965 16 20.1258 16 18.8202V7.05757L10.6667 0H1.77778ZM15.1111 19.0909H0.888889V0.909091H8.88889V9.4101H15.1111V19.0909ZM9.77778 8.23384V0.909091L12.4444 4.70505L15.1111 8.23384H9.77778Z" />
                      </svg>
                    </div>
                    <div
                      className={documentPageSize.title !== "Landscape" ? "orientation-color-selected ml-2" : "orientation-color ml-2"}
                      style={{
                        alignSelf: "center",
                        fontSize: "14px",
                      }}
                  ...
                  <div className="d-flex align-items-center justify-content-center">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" viewBox="0 0 20 16" fill="none">
                        <path className={documentPageSize.title == "Landscape" ? "orientation-svg-selected" : "orientation-svg"} d="M20 1.77778C20 0.791111 18.9531 0 17.6475 0L1.1798 0C-0.114086 0 0.00354004 0.791111 0.00354004 1.77778V14.2222C0.00354004 15.2089 -0.125849 16 1.1798 16H12.9424L20 10.6667V1.77778ZM0.90909 15.1111V0.888889L19.0909 0.888889V8.88889H10.5899V15.1111L0.90909 15.1111ZM11.7662 9.77778H19.0909L15.295 12.4444L11.7662 15.1111V9.77778Z" fill="#7F7F7F" />
                      </svg>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      <div className="" style={{ padding: "0 8px" }}>
                        <div
                          ...
                          className={
                            documentPageSize.title == size.title ? "page-sizing-color-selected" : "page-sizing-color"
                          }
                        >
                          {size.title}
                        </div>
              ...
              >
                  ...
                  <div className="d-flex">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
                        <path className={selectedColumn == "one" ? "column-svg-selected" : "column-svg"} d="M3.33333 4.21429H14.6667M3.33333 6.35714H14.6667M3.33333 8.5H14.6667M3.33333 10.6429H14.6667M3.33333 12.7857H14.6667M3.33333 14.9286H14.6667M3.33333 17.0714H14.6667M1.72727 21H16.2727C16.6744 21 17 20.556 17 20.0083V1.99174C17 1.44402 16.6744 1 16.2727 1H1.72727C1.32561 1 1 1.44401 1 1.99173V20.0083C1 20.556 1.32561 21 1.72727 21Z" stroke="#7771E8" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      style={{
                      ...
                      className={selectedColumn == "one" ? "column-color-selected mx-2" : "column-color mx-2"}
                    >
                      One
                    </div>
                  </div>
                ...
                >
                  <div className="d-flex">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
                        <path className={selectedColumn == "two" ? "column-svg-selected" : "column-svg"} d="M3.33333 4.21429H8M10 4.21429H14.6667M3.33333 6.35714H8M10 6.35714H14.6667M3.33333 8.5H8M10 8.5H14.6667M3.33333 10.6429H8M10 10.6429H14.6667M3.33333 12.7857H8M3.33333 14.9286H8M3.33333 17.0714H8M10 12.7857H14.6667M10 14.9286H14.6667M10 17.0714H14.6667M1.72727 21H16.2727C16.6744 21 17 20.556 17 20.0083V1.99174C17 1.44402 16.6744 1 16.2727 1H1.72727C1.32561 1 1 1.44401 1 1.99173V20.0083C1 20.556 1.32561 21 1.72727 21Z" stroke="#7F7F7F" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      style={{
                      ...
                      className={selectedColumn == "two" ? "column-color-selected mx-2" : "column-color mx-2"}
                    >
                      Two
                    </div>
                  </div>
                ...
                >
                  <div className="d-flex">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
                        <path className={selectedColumn == "three" ? "column-svg-selected" : "column-svg"} d="M7.66667 4.21429H10.3333M12 4.21429H14.6667M3.33333 4.21429H6M3.33333 6.35714H6M3.33333 8.5H6M3.33333 10.6429H6M3.33333 12.7857H6M3.33333 14.9286H6M3.33333 17.0714H6M7.66667 6.35714H10.3333M12 6.35714H14.6667M12 8.5H14.6667M7.66667 8.5H10.3333M7.66667 10.6429H10.3333M7.66667 12.7857H10.3333M7.66667 14.9286H10.3333M7.66667 17.0714H10.3333M12 10.6429H14.6667M12 12.7857H14.6667M12 14.9286H14.6667M12 17.0714H14.6667M1.72727 21H16.2727C16.6744 21 17 20.556 17 20.0083V1.99174C17 1.44402 16.6744 1 16.2727 1H1.72727C1.32561 1 1 1.44401 1 1.99173V20.0083C1 20.556 1.32561 21 1.72727 21Z" stroke="#7F7F7F" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      style={{
                      ...
                      className={selectedColumn == "three" ? "column-color-selected mx-2" : "column-color mx-2"}
                    >
                      Three
                    </div>
                  </div>
                ...
                >
                  <div className="d-flex">
                    ...
                    <div
                      ...
                      className={selectedColumn == "left" ? "column-color-selected mx-2" : "column-color mx-2"}
                ...
                >
                  <div className="d-flex">
                    <div>
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="22" viewBox="0 0 18 22" fill="none">
                        <path className={selectedColumn == "right" ? "column-svg-selected" : "column-svg"} d="M3.33333 4.21429H9.66667M11.3333 4.21429H14.6667M3.33333 6.35714H9.66667M11.3333 8.5H14.6667M3.33333 8.5H9.66667M11.3333 10.6429H14.6667M3.33333 10.6429H9.66667M11.3333 12.8182H14.6667M3.33333 12.8182H9.66667M3.33333 14.9286H9.66667M3.33333 17.0714H9.66667M11.3333 6.35714H14.6667M11.3333 14.9286H14.6667M11.3333 17.0714H14.6667M1.72727 21H16.2727C16.6744 21 17 20.556 17 20.0083V1.99174C17 1.44402 16.6744 1 16.2727 1H1.72727C1.32561 1 1 1.44401 1 1.99173V20.0083C1 20.556 1.32561 21 1.72727 21Z" stroke="#7F7F7F" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                      style={{
                      ...
                      className={selectedColumn == "right" ? "column-color-selected mx-2" : "column-color mx-2"}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="container margins-color" style={{ fontSize: 12 }}>
                  ...
                  <div className="d-flex align-items-center">
                    <div className="mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" viewBox="0 0 18 16" fill="none">
                        <path className="media-svg" d="M13.6316 5.66667V1H1V8M7.73684 11.7333H1V8M1 8L5.21053 3.8L7.73684 6.13333" stroke="#7F7F7F" />
                        <ellipse cx="11.1053" cy="3.79997" rx="0.842105" ry="0.933333" fill="#7F7F7F" />
                        <path className="media-svg" d="M12.7896 12.7091V15M10.6844 15H14.8949M17.0002 11.9454C17.0002 12.3672 16.686 12.7091 16.2984 12.7091H9.28086C8.89329 12.7091 8.5791 12.3672 8.5791 11.9454V7.36361C8.5791 6.94187 8.89329 6.59998 9.28086 6.59998H16.2984C16.686 6.59998 17.0002 6.94187 17.0002 7.36361V11.9454Z" stroke="#7F7F7F" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </div>
                    <div
                  ...
                  <div className="d-flex align-items-center">
                    <div className="mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
                        <path className="media-svg" d="M11.909 14.0909C10.6623 13.1559 10.0389 11.2857 10.0389 9.72728C10.0389 8.16884 10.6623 6.29871 11.909 5.36365M11.909 14.0909C13.1558 13.1559 13.7792 11.2857 13.7792 9.72728C13.7792 8.16884 13.1558 6.29871 11.909 5.36365M11.909 14.0909C14.319 14.0909 16.2727 12.1373 16.2727 9.72728M11.909 14.0909C9.49908 14.0909 7.54541 12.1373 7.54541 9.72728M11.909 5.36365C14.319 5.36365 16.2727 7.31731 16.2727 9.72728M11.909 5.36365C9.49908 5.36365 7.54541 7.31731 7.54541 9.72728M7.96557 7.85715H15.8525M7.96557 11.5974H15.8525M7.54541 9.72728H16.2727" stroke="#7F7F7F" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path className="media-svg" d="M13.3077 4.69231V1H1V7.15385M6.45455 10.4359H1V7.15385M1 7.15385L5.10256 3.46154L7.90909 5.72727" stroke="#7F7F7F" />
                        <ellipse cx="11.2565" cy="3.87178" rx="0.820513" ry="0.820513" fill="#7F7F7F" />
                      </svg>
                    </div>
